...
object patternExtraction{
	def main(args:Array[String]) = {
		...
		/*****************************************************************************************************	
						...
						ex: (born June 14, 1946)										
		*****************************************************************************************************/
		val dobRegEx = "(\\(born [^)]+\\))".r                     			
		// regular expression string = "(born ... anything up to )"
		val dob = txtThree.flatMap(line=>(dobRegEx findAllIn line))
		println("----------------------------------------------------------------------------------------")
		println("Printing DOB for each from each candidate/file")
		println("	")			// spaces
		println("	")			// spaces
		// TEMPORARILY REMOVED	dob.collect.foreach(println)	
		println("----------------------------------------------------------------------------------------")


      		/**************************************************************************************************** 		
			YEARS: Regular Expressions syntax @ ---> 
	...
	// TEMPORARILY REMOVED	        yearsReduced.collect.foreach(println)
	println("----------------------------------------------------------------------------------------")	
	...
	**************************************************************************************************/
		...
		// TEMPORARILY REMOVED datesExtracted.collect.foreach(println)
	...
	***************************************************************************************************/
		...
		// TEMPORARILY REMOVED		quotesExtracted.collect.foreach(println)
